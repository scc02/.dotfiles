...
-- 显示当前buffer的LSP错误到quickfix，光标保持在当前位置
map('n', ',e', function()
  ...
  if #qf_items > 0 then
    ...
    print('No LSP errors found in current buffer')
  end
end)
...
vim.keymap.set('v', ',c', function()
    ...
    local line_info = start_line == end_line and (' 第' .. start_line .. '行') or (' 第' .. start_line .. '-' .. end_line .. '行')
